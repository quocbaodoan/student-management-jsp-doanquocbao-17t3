...
@WebServlet(name = "HandleAddSchedule", urlPatterns = { "/HandleAddSchedule" })
public class HandleAddSchedule extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			schedule.setMamonhoc(removeAccent(request.getParameter("tenmonhoc")));
