...
@WebServlet(name = "HandleAddStudent", urlPatterns = { "/HandleAddStudent" })
public class HandleAddStudent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			System.out.print(request.getParameter("matkhau"));
