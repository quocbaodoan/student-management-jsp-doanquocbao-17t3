...
@WebServlet(urlPatterns = { "/admin/schedulemanagement" })
public class ScheduleManagementServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// đặt trong WEB-INF)
		RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/views/ScheduleManagement.jsp");
